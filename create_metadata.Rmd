...
get_gc_content <- function(dataset){
  ...
  gc_content_ens97 <- 
   ...
   dplyr::rename(gene_id="ensembl_gene_id",
                 gene_id_version="ensembl_gene_id_version",
...
create_tx_gene_metadata <- function(ah_id, dataset){
  ...
  tx_gene_meta %>%
   dplyr::select(tx_id, gene_name, gene_len, premrna_len, intronic_len, exonic_len,
                 ...
                 gene_id, seqnames, gene_biotype, tx_biotype, tx_id_version, gene_id_version)
  return(tx_gene_meta)
}
...
```{r}
write_csv( mm10_tx_gene_meta, "./data/mm_ens97_metadata.txt")
write_csv( hg38_tx_gene_meta, "./data/hg_ens97_metadata.txt")
